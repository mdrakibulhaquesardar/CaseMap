...
const steps = [
  {
    ...
    description: 'আপনি যখন আপনার আইনি প্রশ্নটি আমাদের চ্যাটবটে লেখেন, সিস্টেমটি প্রথমে আপনার প্রশ্নের মূল উদ্দেশ্য বোঝার চেষ্টা করে।',
  },
  {
    icon: BookOpen,
    title: '২. প্রাসঙ্গিক তথ্য অনুসন্ধান',
    description: 'এরপর, AI বাংলাদেশের আইন, পূর্ববর্তী মামলার রায় এবং আইনি ব্যাখ্যার বিশাল ডেটাবেস থেকে আপনার প্রশ্নের সাথে সম্পর্কিত তথ্য খুঁজে বের করে।',
  },
  {
    icon: BrainCircuit,
    title: '৩. উত্তর তৈরি',
    description: 'AI সংগৃহীত তথ্যের ওপর ভিত্তি করে একটি খসড়া উত্তর তৈরি করে। এই পর্যায়ে, এটি বিভিন্ন আইনি ধারা ও ধারণাকে একত্রিত করে।',
  },
  {
    icon: Bot,
    title: '৪. সহজ ভাষায় রূপান্তর ও প্রদান',
    description: 'সবশেষে, AI তার তৈরি করা উত্তরটিকে সহজ, সাধারণ মানুষের বোধগম্য বাংলা ভাষায় রূপান্তরিত করে এবং আপনার কাছে উপস্থাপন করে।',
  },
]
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
            আমাদের AI মডেল কীভাবে আপনার আইনি প্রশ্নের উত্তর দেয় তার পেছনের প্রযুক্তি সম্পর্কে জানুন।
          </p>
        </div>
