        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            <main className="lg:col-span-3 prose dark:prose-invert max-w-none">
                ...
                <section id="introduction">
                    <p>CaseMap ("আমরা", "আমাদের") আপনার গোপনীয়তা রক্ষা করতে প্রতিশ্রুতিবদ্ধ। এই গোপনীয়তা নীতি ব্যাখ্যা করে যে আমরা কীভাবে আপনার ব্যক্তিগত তথ্য সংগ্রহ, ব্যবহার এবং প্রকাশ করি। এই নীতিটি আমাদের ওয়েবসাইট, মোবাইল অ্যাপ এবং অন্যান্য পরিষেবার ক্ষেত্রে প্রযোজ্য।</p>
