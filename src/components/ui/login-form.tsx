        ...
        <div className="flex h-screen w-full items-center justify-center bg-background">
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <form className="md:w-96 w-80 flex flex-col items-center justify-center" onSubmit={handleSignIn}>
                    ...
                    <p className="text-sm text-muted-foreground mt-3">স্বাগতম! চালিয়ে যেতে সাইন ইন করুন</p>
                    ...
                    <div className="flex items-center gap-4 w-full my-5">
                        ...
                        <p className="w-full text-nowrap text-sm text-muted-foreground">অথবা ইমেল দিয়ে সাইন ইন করুন</p>
                        <div className="w-full h-px bg-border"></div>
                    </div>
                    ...
                    <div className="w-full flex items-center justify-between mt-8 text-muted-foreground">
                        <div className="flex items-center gap-2">
                            ...
                            <label className="text-sm" htmlFor="checkbox">আমাকে মনে রাখুন</label>
                        </div>
                    ...
                    <p className="text-muted-foreground text-sm mt-4">অ্যাকাউন্ট নেই? <Link className="text-primary hover:underline" href="/signup">সাইন আপ</Link></p>
                </form>
            </div>
        </div>
    );
